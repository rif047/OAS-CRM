                                ...
                                <div className="grid md:grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            ...
                                            {isClosed && <InfoRow label="Received" value={formatCurrencyGBP(viewData.payment_received_total || 0)} />}
                                            {isClosed && <InfoRow label="Discount" value={formatCurrencyGBP(viewData.payment_discount_total || 0)} />}
                                        </div>
